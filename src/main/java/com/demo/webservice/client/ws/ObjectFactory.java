 ...
 * generated in the com.demo.webservice.client.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetValue_QNAME = new QName("http://server.webservice.demo.com/", "getValue");
    private final static QName _GetValueResponse_QNAME = new QName("http://server.webservice.demo.com/", "getValueResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.demo.webservice.client.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.webservice.demo.com/", name = "getValue")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.webservice.demo.com/", name = "getValueResponse")
