 ...
 * 
 */
@WebServiceClient(name = "HelloServiceService", targetNamespace = "http://server.webservice.demo.com/", wsdlLocation = "http://localhost:8888/server/helloService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICESERVICE_QNAME = new QName("http://server.webservice.demo.com/", "HelloServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8888/server/helloService?wsdl");
    ...
    public HelloService getHelloServicePort() {
        return super.getPort(new QName("http://server.webservice.demo.com/", "HelloServicePort"), HelloService.class);
    }
    ...
    public HelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.webservice.demo.com/", "HelloServicePort"), HelloService.class, features);
    }
